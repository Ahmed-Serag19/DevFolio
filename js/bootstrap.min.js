...
!(function (t, e) {
  ...
  class rt extends W {
    ...
    _setActiveIndicatorElement(t) {
      ...
      i &&
        (i.classList.add(it), i.setAttribute('aria-current', 'true'));
    }
    _updateInterval() {
  ...
  function Ut(t, e, i) {
    ...
    e &&
      ...
      (o =
        (t.offsetHeight > 0 && Qt(n.height) / t.offsetHeight) || 1));
  ...
  function ne(t) {
    return Bt(t) && 'fixed' !== Zt(t).position
      ? t.offsetParent
      : null;
  }
  function se(t) {
        ...
        var s =
            'clippingParents' === e
              ? (function (t) {
                  var e = Te(ie(t)),
                    i =
                      ['absolute', 'fixed'].indexOf(Zt(t).position) >=
                        0 && Bt(t)
                        ? se(t)
                        : t;
                  return Wt(i)
